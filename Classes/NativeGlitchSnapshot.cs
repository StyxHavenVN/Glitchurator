...
namespace StandalonePicturator.Classes
{
    public sealed class NativeGlitchSnapshot : IDisposable
    {
        ...
        public NativeGlitchSnapshot(Bitmap source, double amount, double frequency, int thickness, int seed, double resolution, LayerEffects effects = null, bool isGlitchOn = true, double angle = 0)
        {
        ...
        private void ApplyLegacyGlitch(double[,] field)
        {
            ...
            // 3. Lát cắt trượt ngang (Slice Displacement)
